...
import { useCurrentUser, useDefaultIndentSize, useIsGuestUser, useIsReadOnlyUser } from '~/stores-universal/context';
...
export const useCurrentIndentSize = (): SWRResponse<number, Error> => {
  ...
  return useSWRStatic<number, Error>(defaultIndentSize == null ? null : 'currentIndentSize', undefined, { fallbackData: defaultIndentSize });
};
