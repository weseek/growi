    ...
    <Modal size="md" isOpen={isOpened} toggle={closeBookmarkFolderDeleteModal} data-testid="page-delete-modal" className="grw-create-page">
      ...
      <ModalBody>
        <div className="pb-1 text-break">
          <label className="form-label">{t('bookmark_folder.delete_modal.modal_body_description')}:</label>
          <br />
      ...
      <ModalFooter>
        <button type="button" className="btn btn-danger" onClick={onClickDeleteButton}>
