...
export const BookmarkItem = (props: Props): JSX.Element => {
  ...
  const { isReadOnlyUser, isOperable, bookmarkedPage, onClickDeleteMenuItemHandler, parentFolder, level, canMoveToRoot, bookmarkFolderTreeMutation } = props;
  ...
  return (
    <DragAndDropWrapper item={dragItem} type={[DRAG_ITEM_TYPE.BOOKMARK]} useDragMode={isOperable}>
      <li
      ...
      >
        ...
        <div className="grw-foldertree-control">
          <PageItemControl
            ...
            additionalMenuItemOnTopRenderer={
              canMoveToRoot ? () => <BookmarkMoveToRootBtn pageId={bookmarkedPage._id} onClickMoveToRootHandler={onClickMoveToRootHandler} /> : undefined
            }
          >
        ...
        <UncontrolledTooltip autohide={false} placement="right" target={bookmarkItemId} fade={false}>
