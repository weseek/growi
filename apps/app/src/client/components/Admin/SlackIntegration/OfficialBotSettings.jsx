...
const OfficialBotSettings = (props) => {
  const { slackAppIntegrations, onClickAddSlackWorkspaceBtn, onPrimaryUpdated, connectionStatuses, onUpdateTokens, onSubmitForm } = props;
    ...
    <>
      <h2 className="admin-setting-header">
        ...
        <a href={t('admin:slack_integration.docs_url.official_bot')} target="_blank" rel="noopener noreferrer">
          <span className="growi-custom-icons btn-link ms-2" onClick={() => window.open(`${t('admin:slack_integration.docs_url.official_bot')}`, '_blank')}>
            external_link
          </span>
        </a>
      </h2>
