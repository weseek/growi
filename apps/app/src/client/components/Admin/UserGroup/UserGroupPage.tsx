...
import { GroupType, getIdForRef, type IGrantedGroup, type IUserGroup, type IUserGroupHasId } from '@growi/core';
...
export const UserGroupPage: FC = () => {
  ...
  return (
    <div data-testid="admin-user-groups">
      ...
      <UserGroupModal buttonLabel={t('Create')} onClickSubmit={createUserGroup} isShow={isCreateModalShown} onHide={hideCreateModal} />
