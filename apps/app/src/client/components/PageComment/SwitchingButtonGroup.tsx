...
export const SwitchingButtonGroup = (props: Props): JSX.Element => {
  ...
  return (
    <div className={`btn-group ${moduleClass}`} role="group">
      <SwitchingButton active={showPreview} className="ps-2 pe-3" onClick={() => onSelected?.(true)}>
      ...
      <SwitchingButton active={!showPreview} className="px-2" onClick={() => onSelected?.(false)}>
