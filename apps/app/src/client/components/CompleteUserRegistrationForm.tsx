...
export const CompleteUserRegistrationForm: React.FC<Props> = (props: Props) => {
  ...
  const { email, token, errorCode, registrationMode, isEmailAuthenticationEnabled } = props;
          ...
          <div className="col-12 px-4">
            ...
            <form role="form" onSubmit={handleSubmitRegistration} id="registration-form">
              ...
              <div className="input-group justify-content-center mt-4">
                <button type="submit" disabled={forceDisableForm || disableForm} className="btn btn-secondary btn-register col-6 mx-auto d-flex">
                  <span>
