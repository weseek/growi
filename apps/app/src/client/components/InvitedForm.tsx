    ...
    <div className="nologin-dialog px-3 pb-3 mx-auto" id="nologin-dialog">
      ...
      <form role="form" onSubmit={submitHandler} id="invited-form">
        ...
        <div className="input-group">
          ...
          <input type="text" className="form-control" disabled placeholder={t('Email')} name="invitedForm[email]" defaultValue={user.email} required />
        </div>
        {/* UserID Form */}
        <div className="input-group" id="input-group-username">
          ...
          <input type="text" className="form-control" placeholder={t('User ID')} name="invitedForm[username]" value={invitedFormUsername} required />
        </div>
        {/* Name Form */}
        <div className="input-group">
          <span className="input-group-text">
          ...
          <input type="text" className="form-control" placeholder={t('Name')} name="invitedForm[name]" value={invitedFormName} required />
        </div>
        {/* Password Form */}
        <div className="input-group">
          <span className="input-group-text">
          ...
          <input type="password" className="form-control" placeholder={t('Password')} name="invitedForm[password]" required minLength={6} />
        </div>
        {/* Create Button */}
        <div className="input-group justify-content-center d-flex mt-4">
          <button type="submit" className="btn btn-fill" id="register" disabled={isLoading}>
            <span className="btn-label">{isLoading ? <LoadingSpinner /> : <span className="material-symbols-outlined">person_add</span>}</span>
