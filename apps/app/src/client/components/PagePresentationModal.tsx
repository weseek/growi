...
const PagePresentationModal = (): JSX.Element => {
  ...
  return (
    <Modal isOpen={isOpen} toggle={closeHandler} data-testid="page-presentation-modal" className={moduleClass}>
      <div className="grw-presentation-controls d-flex">
        <button className="btn material-symbols-outlined" type="button" aria-label="fullscreen" onClick={toggleFullscreenHandler}>
