  ...
  return (
    <form className="data-import-form">
      ...
      <Collapse isOpen={parserErrorMessage != null}>
        <div>
          <label htmlFor="data-import-form-type-textarea-alert" className="form-label">
            {t('parse_error')}
          </label>
          <textarea id="data-import-form-type-textarea-alert" className="form-control" rows={4} value={parserErrorMessage || ''} readOnly />
        </div>
      </Collapse>
