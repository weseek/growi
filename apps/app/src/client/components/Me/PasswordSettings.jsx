...
class PasswordSettings extends React.Component {
  ...
  render() {
    ...
    return (
      <React.Fragment>
        {!this.state.isPasswordSet && <div className="alert alert-warning">{t('personal_settings.password_is_not_set')}</div>}
        ...
        {this.state.isPasswordSet && (
          <div className="row mb-3">
            <label htmlFor="oldPassword" className="col-md-3 text-md-end col-form-label">
        ...
        <div className="row mb-3">
          <label htmlFor="newPassword" className="col-md-3 text-md-end col-form-label">
        ...
        <div className={`row mb-3 ${isIncorrectConfirmPassword && 'has-error'}`}>
          <label htmlFor="newPasswordConfirm" className="col-md-3 text-md-end col-form-label">
