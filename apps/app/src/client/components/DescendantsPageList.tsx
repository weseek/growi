...
import type { IDataWithMeta, IPageHasId, IPageInfoForOperation } from '@growi/core';
...
import { mutatePageTree, useSWRxPageInfoForList, useSWRxPageList, mutateRecentlyUpdated } from '~/stores/page-listing';
...
const DescendantsPageListSubstance = (props: SubstanceProps): JSX.Element => {
  ...
  const { pagingResult, activePage, setActivePage, forceHideMenuItems, onPagesDeleted, onPagePutBacked } = props;
