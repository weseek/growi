...
type ExtractPropertyDefinition<T> = T extends Record<string, (infer U)[]> ? U : never;
...
export const tagNames: Array<string> = [...(defaultSchema.tagNames ?? []), '-', 'bdi', 'button', 'col', 'colgroup', 'data', 'iframe', 'video', 'rb', 'u'];
