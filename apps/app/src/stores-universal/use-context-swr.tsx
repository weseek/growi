...
export function useContextSWR<Data, Error>(
  ...args: readonly [Key] | readonly [Key, Data | undefined] | readonly [Key, Data | undefined, SWRConfiguration<Data, Error> | undefined]
): SWRResponse<Data, Error> {
  ...
  const result = Object.assign(swrResponse, {
    mutate: () => {
      throw new Error('mutate can not be used in context');
    },
  });
