...
export const getPageSchema = (crowi) => {
  ...
  pageSchema.methods.isUpdatable = async function(previousRevision, origin) {
    ...
    const ignoreLatestRevision = (origin === Origin.Editor || origin === Origin.EditorOffline) && (latestRevisionOrigin === Origin.Editor || latestRevisionOrigin === Origin.EditorOffline || latestRevisionOrigin === Origin.View);
