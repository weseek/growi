...
module.exports = function(crowi, app) {
  ...
  apiV1Router.post('/attachments.uploadProfileImage'   , uploads.single('file'), autoReap, accessTokenParser, loginRequiredStrictly, csrfProtection, excludeReadOnlyUser, attachmentApi.uploadProfileImage);
