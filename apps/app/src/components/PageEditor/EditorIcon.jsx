...
const EditorIcon = (props) => {
  ...
  switch (props.icon) {
    ...
    case 'SelectablePaste':
      return (
        <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" viewBox="0 0 30 30">
          <rect fill="none" height="1.87" id="svg_2" rx="26.13" ry="26.13" stroke="currentColor" strokeLinejoin="round" width="4.67" x="12.67" y="8" />
          <path d="m17.33,8.93l0.93,0a1.4,1.4 0 0 1 1.4,1.4l0,9.33a1.4,1.4 0 0 1 -1.4,1.4l-6.53,0a1.4,1.4 0 0 1 -1.4,-1.4l0,-9.33a1.4,1.4 0 0 1 1.4,-1.4l0.93,0" fill="none" id="svg_1" stroke="currentColor" strokeLinejoin="round" />
        </svg>
      );
  }
