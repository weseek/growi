...
export const useActionMsgAndIconForPageModelNotification = (notification: IInAppNotification<IUser | IPage> & HasObjectId): ActionMsgAndIconType => {
...
export const useActionMsgAndIconForUserModelNotification = (notification: IInAppNotification<IUser | IPage> & HasObjectId): ActionMsgAndIconType => {
  const actionType: string = notification.action;
  let actionMsg: string;
  let actionIcon: string;
