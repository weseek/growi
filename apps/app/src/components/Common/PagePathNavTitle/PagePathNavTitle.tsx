...
const PagePathNavSticky = withLoadingProps<PagePathNavLayoutProps>((useLoadingProps) =>
  dynamic(() => import('~/client/components/PagePathNavSticky').then((mod) => mod.PagePathNavSticky), {
    ssr: false,
    loading: () => {
