...
import type { Types, Document, Model, Query } from 'mongoose';
...
const add: Add = async function (this: CommentModel, pageId, creatorId, revisionId, comment, commentPosition, replyTo?): Promise<CommentDocument> {
  try {
