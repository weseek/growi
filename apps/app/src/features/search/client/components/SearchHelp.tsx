        ...
        <table className="table table-borderless m-0">
          <tbody>
            <tr className="border-bottom">
              ...
              <td>
                <h6 className="m-0 text-muted">{t('search_help.and.desc', { word1: 'word1', word2: 'word2' })}</h6>
              </td>
            </tr>
            <tr className="border-bottom">
              <th className="py-2">
              ...
              <td>
                <h6 className="m-0 text-muted">{t('search_help.phrase.desc', { phrase: 'This is GROWI' })}</h6>
              </td>
            </tr>
            <tr className="border-bottom">
              <th className="py-2">
              ...
              <td>
                <h6 className="m-0 text-muted">{t('search_help.exclude.desc', { word: 'keyword' })}</h6>
              </td>
            </tr>
            <tr className="border-bottom">
              <th className="py-2">
              ...
              <td>
                <h6 className="m-0 text-muted">{t('search_help.prefix.desc', { path: '/user/' })}</h6>
              </td>
            </tr>
            <tr className="border-bottom">
              <th className="py-2">
              ...
              <td>
                <h6 className="m-0 text-muted">{t('search_help.exclude_prefix.desc', { path: '/user/' })}</h6>
              </td>
            </tr>
            <tr className="border-bottom">
              <th className="py-2">
              ...
              <td>
                <h6 className="m-0 text-muted">{t('search_help.tag.desc', { tag: 'wiki' })}</h6>
              </td>
            </tr>
            <tr>
              <th className="py-2">
              ...
              <td>
                <h6 className="m-0 text-muted">{t('search_help.exclude_tag.desc', { tag: 'wiki' })}</h6>
              </td>
            </tr>
          </tbody>
        </table>
