...
export const AccessScopeDropdown: React.FC<Props> = (props: Props) => {
  ...
  const getAccessScopeLabel = useCallback(
    (accessScope: AiAssistantAccessScope) => {
      ...
      return accessScope === AiAssistantAccessScope.OWNER ? t(baseLabel, { username: currentUser?.username }) : t(baseLabel);
    },
  ...
  return (
    <div className="mb-4">
      ...
      <UncontrolledDropdown>
        <DropdownToggle disabled={isDisabled} caret className="btn-outline-secondary bg-transparent">
