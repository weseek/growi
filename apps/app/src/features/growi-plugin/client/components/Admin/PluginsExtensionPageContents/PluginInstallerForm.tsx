    ...
    <form role="form" onSubmit={submitHandler}>
      <div className="row">
        ...
        <div className="col-md-6">
          <input className="form-control" type="text" name="pluginInstallerForm[url]" placeholder="https://github.com/weseek/growi-plugins-example" required />
      ...
      <div className="row">
        ...
        <div className="col-md-6">
          <input className="form-control col-md-3" type="text" name="pluginInstallerForm[ghBranch]" placeholder="main" />
