...
class PassportService {
  ...
  setupTwitterStrategy() {
    ...
    passport.use(new TwitterStrategy({
      consumerKey: config.crowi['security:passport-twitter:consumerKey'] || process.env.OAUTH_TWITTER_CLIENT_ID,
      consumerSecret: config.crowi['security:passport-twitter:consumerSecret'] || process.env.OAUTH_TWITTER_CLIENT_SECRET,
