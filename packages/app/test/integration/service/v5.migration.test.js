...
describe('V5 page migration', () => {
  ...
  describe.only('should normalize only selected pages recursively (especially should NOT normalize non-selected ancestors)', () => {
    /*
     * # Test flow
     * - Existing pages
