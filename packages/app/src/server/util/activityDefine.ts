...
const ACTION_PAGE_RECURSIVERY_RENAME = 'PAGE_RECURSIVERY_RENAME';
const ACTION_PAGE_RECURSIVERY_DELETE = 'PAGE_RECURSIVERY_DELETE';
const ACTION_PAGE_RECURSIVERY_DELETE_COMPLETELY = 'PAGE_RECURSIVERY_DELETE_COMPLETELY';
...
const activityDefine = {
  ...
  ACTION_PAGE_DELETE,
  ACTION_PAGE_DELETE_COMPLETELY,
  ACTION_PAGE_RECURSIVERY_RENAME,
  ACTION_PAGE_RECURSIVERY_DELETE,
  ACTION_PAGE_RECURSIVERY_DELETE_COMPLETELY,
  ACTION_COMMENT_CREATE,
  ACTION_COMMENT_UPDATE,
