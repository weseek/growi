...
* [`5.1.8`, `5.1`, `5`, `latest` (Dockerfile)](https://github.com/weseek/growi/blob/v5.1.8/packages/app/docker/Dockerfile)
* [`5.1.8-nocdn`, `5.1-nocdn`, `5-nocdn`, `latest-nocdn` (Dockerfile)](https://github.com/weseek/growi/blob/v5.1.8/packages/app/docker/Dockerfile)
