...
export const Gallery = React.memo((props: Props): React.ReactElement => {
...
export const GalleryImmutable = React.memo((props: Omit<Props, 'isImmutable'>): React.ReactElement => {
  const grid = props.grid || gridDefault;
  const gridGap = props.gridGap || gridGapDefault;
