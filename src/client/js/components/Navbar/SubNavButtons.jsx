...
import { useIsAbleToShowPageReactionButtons, useIsAbleToShowLikeButton, useIsAbleToShowPageManagement } from '~/stores/ui';
    ...
    <>
      {isViewMode && (
        <>
          ...
          { isAbleToShowPageManagement && <PageManagement isCompactMode={isCompactMode} /> }
        </>
      )}
    </>
  );
