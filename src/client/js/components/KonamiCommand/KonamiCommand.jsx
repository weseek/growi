...
export default class KonamiCommand extends React.Component {
  ...
  constructor(props) {
    ...
    this.konamiCommandList = [['ArrowUp', 'ArrowUp', 'ArrowDown', 'ArrowDown', 'ArrowLeft', 'ArrowRight', 'ArrowLeft', 'ArrowRight', 'b', 'a'],
  ...
  check(event) {
    ...
    this.konamiCommandList = this.konamiCommandList.filter((value) => {
