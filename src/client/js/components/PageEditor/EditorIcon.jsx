  ...
  switch (props.icon) {
    ...
    case 'List':
      return (
        <svg xmlns="http://www.w3.org/2000/svg" height="30" viewBox="0 0 30 30">
          <rect fillOpacity="0" width="30" height="30" />
          <circle id="楕円形_14" data-name="楕円形 14" cx="8.5" cy="9.5" r="1" /><circle id="楕円形_15" data-name="楕円形 15" cx="8.5" cy="14.5" r="1" /><circle id="楕円形_16" data-name="楕円形 16" cx="8.5" cy="19.5" r="1" /><path id="長方形_315" data-name="長方形 315" d="M11.5,9h10a.5.5,0,0,1,.5.5h0a.5.5,0,0,1-.5.5h-10a.5.5,0,0,1-.5-.5h0A.5.5,0,0,1,11.5,9Z" /><path id="長方形_316" data-name="長方形 316" d="M11.5,14h10a.5.5,0,0,1,.5.5h0a.5.5,0,0,1-.5.5h-10a.5.5,0,0,1-.5-.5h0A.5.5,0,0,1,11.5,14Z" /><path id="長方形_317" data-name="長方形 317" d="M11.5,19h10a.5.5,0,0,1,.5.5h0a.5.5,0,0,1-.5.5h-10a.5.5,0,0,1-.5-.5h0A.5.5,0,0,1,11.5,19Z" />
        </svg>
      );
    case 'NumberedList':
      return (
        <svg xmlns="http://www.w3.org/2000/svg" height="30" viewBox="0 0 30 30">
          <rect fillOpacity="0" width="30" height="30" />
          <path d="M11.5,9h10a.5.5,0,0,1,.5.5h0a.5.5,0,0,1-.5.5h-10a.5.5,0,0,1-.5-.5h0A.5.5,0,0,1,11.5,9Z" /><path id="長方形_325" data-name="長方形 325" d="M11.5,19h10a.5.5,0,0,1,.5.5h0a.5.5,0,0,1-.5.5h-10a.5.5,0,0,1-.5-.5h0A.5.5,0,0,1,11.5,19Z" /><path id="長方形_326" data-name="長方形 326" d="M11.5,14h10a.5.5,0,0,1,.5.5h0a.5.5,0,0,1-.5.5h-10a.5.5,0,0,1-.5-.5h0A.5.5,0,0,1,11.5,14Z" /><path id="パス_511" data-name="パス 511" d="M7.44,12h.85V8.62L7.58,9h-.1a.24.24,0,0,1-.29-.19.25.25,0,0,1,.19-.3l.83-.41A.77.77,0,0,1,8.5,8h.08a.29.29,0,0,1,.29.27V12H9.6a.27.27,0,1,1,.1.53H7.44a.27.27,0,0,1,0-.53Z" /><path id="パス_512" data-name="パス 512" d="M7.61,17.13a.26.26,0,0,1-.26.26h0c-.14,0-.27-.09-.26-.32v-.4a.48.48,0,0,1,.27-.42,1.93,1.93,0,0,1,1-.25,1.3,1.3,0,0,1,1.42,1.15v.22a2.54,2.54,0,0,1-1,1.74l-1,.94H9.58a.27.27,0,0,1,0,.53H7.32A.32.32,0,0,1,7,20.26v0a.47.47,0,0,1,.2-.34l1.2-1.17a2.12,2.12,0,0,0,.79-1.36.8.8,0,0,0-.75-.85H8.35a1.32,1.32,0,0,0-.7.2Z" />
        </svg>
      );
    case 'CheckList':
      return (
