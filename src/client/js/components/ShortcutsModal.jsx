...
const ShortcutsModal = (props) => {
  ...
  return (
    <>
              ...
              <div className="col-lg-6">
                ...
                <table className="table">
                  <tr>
                    ...
                    <td><span className="key cmd-key"></span> + <span className="key">/</span></td>
                  </tr>
                  <tr>
                    <th>{ t('modal_shortcuts.global.Create Page') }:</th>
                    <td><span className="key">C</span></td>
                  </tr>
                  <tr>
                    <th>{ t('modal_shortcuts.global.Edit Page') }:</th>
                    <td><span className="key">E</span></td>
                  </tr>
                  <tr>
                    ...
                    <td>
                      ...
                      <span className="key key-small">↓</span>&nbsp;<span className="key key-small">↓</span>
                      <span className="key key-small">←</span><br /><span className="key key-small">→</span>
                      <span className="key key-small">←</span>&nbsp;<span className="key key-small">→</span>
                  ...
                  <tr>
                    ...
                    <td>
                      ...
                      <span className="key key-small">A</span><br /><span className="key key-small">Y</span>
              ...
              <div className="col-lg-6">
                ...
                <table className="table">
                  <tr>
                    ...
                    <td><span className="key key-longer">Tab</span></td>
                  </tr>
                  <tr>
                    <th>{ t('modal_shortcuts.editor.Outdent') }:</th>
                    <td className="text-nowrap"><span className="key key-long">Shift</span> + <span className="key key-longer">Tab</span></td>
                  </tr>
                  <tr>
                    <th>{ t('modal_shortcuts.editor.Save Page') }:</th>
                    <td><span className="key cmd-key"></span> + <span className="key">S</span></td>
                  </tr>
                  <tr>
                    <th>{ t('modal_shortcuts.editor.Delete Line') }:</th>
                    <td><span className="key cmd-key"></span> + <span className="key">D</span></td>
                  </tr>
                </table>
                ...
                <table className="table">
                  <tr>
                    ...
                    <td><span className="key cmd-key"></span> +
                      <span className="key key-longer">
                        {/* {%include '../widget/icon-keyboard-return-enter.html' %} */}
                      </span>
                    </td>
                  </tr>
                  <tr>
      ...
      <a href="" onClick={e => toggleIsOpen()}><i className="fa fa-keyboard-o"></i>&nbsp;<span className="cmd-key"></span>-/</a>
    </>
  );
};
