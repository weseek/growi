  ...
  render() {
    ...
    return (
      <>
        ...
        {/* Controls */}
        <div className="row">
          <label className="col-md-3 col-form-label text-md-right">{ t('full_text_search_management.reconnect') }</label>
        ...
        <div className="row">
          <label className="col-md-3 col-form-label text-md-right">{ t('full_text_search_management.normalize') }</label>
          <div className="col-md-6">
        ...
        <div className="row">
          <label className="col-md-3 col-form-label text-md-right">{ t('full_text_search_management.rebuild') }</label>
          <div className="col-md-6">
