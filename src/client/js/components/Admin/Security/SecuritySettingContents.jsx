...
class SecuritySettingContents extends React.Component {
...
SecuritySettingContents.propTypes = {
...
const SecuritySettingContentsWrapper = withUnstatedContainers(SecuritySettingContents, [AppContainer, AdminGeneralSecurityContainer]);

export default withTranslation()(SecuritySettingContentsWrapper);
